...
const Contact = () => {
    ...
    return (
        <div className='text-center px-6 py-20 lg:px-32 w-full overflow-hidden' id="Contact">
            ...
            <p className='max-w-lg mx-auto text-gray-500 text-center mb-12'>Ready to Make a Move? Let's Build Your Future Together</p>
            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto pt-8 text-gray-600'>
                <div className='flex flex-wrap'>
                    <div className='w-full md:w-1/2 text-left'>
                        Your Name
                        <input className='w-full border border-gray-300 rounded py-3 px-4 mt-2' name="name" type="text" placeholder='Your Name' id="" required />
                    </div>
                    <div className='w-full md:w-1/2 text-left md:pl-4'>
                        Your Email
                        <input className='w-full border border-gray-300 rounded py-3 px-4 mt-2' name="email" type="email" placeholder='Your Email' id="" required />
                    </div>
                </div>
